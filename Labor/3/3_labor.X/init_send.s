...
Disp_init:   
    ...
    bclr TRISB,#15 ;kijelz? SCK
    bclr TRISB,#14 ;kijelz? adat
...
Disp_conv:	
	...
	pop w1
	mov #0x0000,w0
    	return  	  ;nem fér ki,legyen sötét
kifer:	
	mov #10,w2
	repeat #17	;osztani fogunk
	div.u	w0,w2 ;w0/10, hányados w0-ba, maradék w1-be
	call NumTo7SEG ;a hányados a fels? helyiérték, az kész
	...
	swap w0 ;a kijelz?n igazából fordítva kell
	pop w2
	pop w1
	return
